...
class AssociationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create association" do
    assert_difference('Association.count') do
      post associations_url, params: { association: { adresse: @association.adresse, description: @association.description, nom: @association.nom } }
    end
  ...
  test "should update association" do
    patch association_url(@association), params: { association: { adresse: @association.adresse, description: @association.description, nom: @association.nom } }
